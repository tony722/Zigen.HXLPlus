...
namespace AET.Zigen.HxlPlus.Tests {
  ...
  public class AudioMatrixTests {
    ...
    public void SwitchInputToOutput_OutputOutOfBounds_GeneratesError() {
      hxl.SwitchAudioInputToOutput(1, 0);
      ErrorMessage.LastErrorMessage.Should().Be("HxlPlus.AudioMatrix.Output(0): Must be between 1 and 8");
      api.SwitchInputToOutput(1, 9);
      ErrorMessage.LastErrorMessage.Should().Be("HxlPlus.AudioMatrix.Output(9): Must be between 1 and 8");
    }
    ...
    public void SwitchInputToOutput_InputOutOfBounds_GeneratesError() {
      ...
      ErrorMessage.LastErrorMessage.Should().Be("HxlPlus.AudioMatrix.Input(0): Must be between 1 and 4");
      api.SwitchInputToOutput(5, 1);
      ErrorMessage.LastErrorMessage.Should().Be("HxlPlus.AudioMatrix.Input(5): Must be between 1 and 4");
    }
    ...
    public void SwitchInputToOutput_SplusDelegateIsTriggered() {
      ...
      hxl.SetAudioOutF = (idx, value) => outputs[idx] = value;
      hxl.SwitchAudioInputToOutput(4,5);
